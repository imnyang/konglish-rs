...
export const DEFAULT_DICTIONARY: Record<string, readonly string[]> =
{
  ...
  "archer of weston-super-mare jeffrey howard archer baron": [
    "바론 아처 웨스턴 슈퍼 메어 제프리 하워드 아처 남작"
  ],
  "archer tim": [
    "아처 팀"
  ],
  ...
  "ashworth jonathan michael graham": [
    "애슈워스 조너선 마이클 그레이엄"
  ],
  "aside": [
    "어사이드"
  ...
  "halsman philippe filips halsmans": [
    "홀스먼 필리프"
  ],
  "halt": [
    "홀트"
  ...
  "maciunas george jurgis mačiūnas": [
    "머추너스 조지"
  ],
  "mackey": [
    "매키"
  ...
  "priebus reinhold richard": [
    "프리버스 라인홀드 리처드"
  ],
  "priest": [
    "프리스트"
  ],
  "priestap edward william": [
    "프리스탭 에드워드 윌리엄"
  ],
  "prima": [
    "프리마"
